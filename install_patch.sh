...
cp "$ROOT/README_NO_SS_SSR_OPENCLASH_SAFE_PATCH.md" "$TARGET/README_NO_SS_SSR_OPENCLASH_SAFE_PATCH.md"
...
echo "  git add scripts/apply_openclash_responsive_stability.py .github/workflows/update-openclash.yml README_NO_SS_SSR_OPENCLASH_SAFE_PATCH.md"
echo "  git commit -m 'Drop SS SSR nodes for OpenClash compatibility'"
